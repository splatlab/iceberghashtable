...
set(command "/usr/bin/cmake;-P;/home/aconway/dash/build/pmdk/tmp/PMDK-gitclone.cmake")
set(log_merged "")
set(log_output_on_failure "")
set(stdout_log "/home/aconway/dash/build/pmdk/src/PMDK-stamp/PMDK-download-out.log")
set(stderr_log "/home/aconway/dash/build/pmdk/src/PMDK-stamp/PMDK-download-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /home/aconway/dash/build/pmdk/src/PMDK-stamp/PMDK-download-*.log")
  endif()
  ...
  set(msg "PMDK download command succeeded.  See also /home/aconway/dash/build/pmdk/src/PMDK-stamp/PMDK-download-*.log")
  message(STATUS "${msg}")
endif()
