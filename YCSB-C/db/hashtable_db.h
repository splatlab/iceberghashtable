...
class HashtableDB : public DB {
 public:
  ...
  int Read(iceberg_table * table, const std::string &key,
           const std::vector<std::string> *fields,
           std::vector<KVPair> &result);
  int Scan(iceberg_table * table, const std::string &key,
           int len, const std::vector<std::string> *fields,
           std::vector<std::vector<KVPair>> &result);
  int Update(iceberg_table * table, const std::string &key,
             std::vector<KVPair> &values);
  int Insert(iceberg_table * table, const std::string &key,
             std::vector<KVPair> &values);
  int Delete(iceberg_table * table, const std::string &key);
