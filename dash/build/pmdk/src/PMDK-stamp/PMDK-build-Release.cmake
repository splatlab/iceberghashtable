...
set(stdout_log "/home/aconway/dash/build/pmdk/src/PMDK-stamp/PMDK-build-out.log")
set(stderr_log "/home/aconway/dash/build/pmdk/src/PMDK-stamp/PMDK-build-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /home/aconway/dash/build/pmdk/src/PMDK-stamp/PMDK-build-*.log")
  endif()
  ...
  set(msg "PMDK build command succeeded.  See also /home/aconway/dash/build/pmdk/src/PMDK-stamp/PMDK-build-*.log")
  message(STATUS "${msg}")
endif()
